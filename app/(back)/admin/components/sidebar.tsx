      ...
      <div className="flex flex-col grow px-6 pb-4 overflow-y-auto gap-y-5 bg-white border-r border-gray-200">
        ...
        <nav className="flex flex-1 flex-col">
          <ul role="list" className="flex flex-col flex-1 gap-y-7">
            ...
            <li>
              <div className="awc awg awp axp">Your teams</div>
              <ul role="list" className="ga lb abo">
                <li>
                  <a
                    ...
                    className="text-gray-700 leading-6 font-semibold text-sm p-2 rounded-md gap-x-3 flex hover:text-indigo-600 hover:bg-gray-50"
                  >
                    <span className="text-gray-400 font-medium text-[0.625rem] bg-white border-gray-200 border rounded-lg flex items-center justify-center shrink-0 w-6 h-6">
                      H
                    </span>
            ...
            <li className="mt-auto">
              <a
                href="#"
                className="text-gray-700 text-gray-700 leading-6 font-semibold text-sm p-2 rounded-md gap-x-3 flex hover:text-indigo-600 hover:bg-gray-50"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
